...
<p>Bitte Loggen Sie sich mit Ihrem Lizenzschlüssel unter <a target='_blank' rel='noopener noreferrer' href='https://www.my-stable.de/scripts/Login.php'>Login</a> ein.</p><br/>
<p>Anschließend können sich alle anderen Reiter Ihres Stalls online Registrieren</p>
<p>Verteilen Sie Ihren Lizenzschlüssel an Ihre Stallgemeinschaft. Registrieren können sich Ihre Reiter dann unter folgendem Link: <a target='_blank' rel='noopener noreferrer' href='https://www.my-stable.de/scripts/registerpage.php'>Registrierung</a>.</p>
