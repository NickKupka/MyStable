								...
								<?php 
									...
									*/
									if ($row['adminAllowed'] == "1") {
										echo "<li class='current' onmouseover=\"this.style.background=' #4db8ff';\" onmouseout=\"this.style.background='white'\";'><a href='#'><img border='0' alt='allusers' src='../../pictures/icons/myicons/png/001-tasks.png'  width='52' height='52'></a></li>";
										$reservation_Time = 24;				
									}
								?>
