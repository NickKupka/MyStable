	...
	<body class="is-preload">
		...
		<!-- Nav -->
			<nav id="nav" style="background: white;">
				<ul>
					<li class="current" onmouseover="this.style.background=' #4db8ff';" onmouseout="this.style.background='white';"><a href="calendarview.php"><img border="0" alt="calendar" src="../pictures/icons/myicons/png/005-calendar-1.png"  width="52" height="52"></a></li>
